...
const PreviewApp = ({ onClose, filePath, fileName }) => {
  const [isMaximized, setIsMaximized] = useState(false);

  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center pb-16 px-4 pointer-events-none">
      <div
        className={`relative bg-[#2d2d2d] rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] overflow-hidden flex flex-col border border-gray-700 pointer-events-auto ${
          isMaximized 
